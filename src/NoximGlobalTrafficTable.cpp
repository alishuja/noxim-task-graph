...
void NoximGlobalTrafficTable::insert(const int src, const int dst, const float pir, const float por, const int t_on, const int t_off, const int t_period){
	NoximCommunication communication;
	communication.src = src;
	communication.dst = dst;
...
void NoximGlobalTrafficTable::setTrafficTable(vector <NoximCommunication> traffic_table){
	this->traffic_table = traffic_table;
}
