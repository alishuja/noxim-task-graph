...
#define DEFAULT_TASKGRAPH_MODE		 	 false
#define DEFAULT_TASKGRAPH_FILENAME		    ""
#define DEFAULT_TASKMAPPING_MODE		 false
#define DEFAULT_TASKMAPPING_MODULE_FILENAME	    ""
#define DEFAULT_TASKMAPPING_INPUT_FILENAME	    ""
...
struct NoximGlobalParams {
    ...
    static bool taskgraph_mode;
    static char taskgraph_filename[128];
    static bool taskmapping_mode;
    static char taskmapping_module_filename[128];
    static char taskmapping_input_filename[128];
};
