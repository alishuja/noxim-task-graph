...
bool NoximGlobalParams::taskgraph_mode = DEFAULT_TASKGRAPH_MODE;
char NoximGlobalParams::taskgraph_filename[128] = DEFAULT_TASKGRAPH_FILENAME;
bool NoximGlobalParams::taskmapping_mode = DEFAULT_TASKMAPPING_MODE;
char NoximGlobalParams::taskmapping_module_filename[128] = DEFAULT_TASKMAPPING_MODULE_FILENAME;
char NoximGlobalParams::taskmapping_input_filename[128] = DEFAULT_TASKMAPPING_INPUT_FILENAME;
